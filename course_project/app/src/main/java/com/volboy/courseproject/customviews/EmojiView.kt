...
class EmojiView @JvmOverloads constructor(
    ...
    var emoji: String = DEFAULT_EMOJI_CODE.toString()
        set(value) {
            if (field != value) {
                field = String(Character.toChars(value.toInt(16)))
                requestLayout()
            }
        }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val mRoundRectWidth = emojiWidth + paddingLeft + paddingRight + context.dpToPx(PADDING_LEFT_AND_RIGHT)
        val mRoundRectHeight = emojiHeight + paddingBottom + paddingTop + context.dpToPx(PADDING_TOP_AND_BOTTOM)
    ...
    companion object {
        ...
        private const val PADDING_LEFT_AND_RIGHT = 18.0F
        private const val PADDING_TOP_AND_BOTTOM = 9.6F
